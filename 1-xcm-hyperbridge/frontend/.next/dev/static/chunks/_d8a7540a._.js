...
function useBridge() {
    ...
    // Định nghĩa hàm
    const handleBridge = async (gateway, feeToken)=>{
        setLoading(true);
        try {
            // Logic của bạn ở đây
            console.log("Đang bridge tới:", gateway);
...
function Home() {
    ...
    const { handleBridge, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useBridge$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBridge"])();
    const onButtonClick = ()=>{
        // Truyền các tham số cần thiết vào (ví dụ gateway address và fee token address)
        const gateway = "0xFcDa26cA021d5535C3059547390E6cCd8De7acA6";
        const feeToken = "0x1794aB22388303ce9Cb798bE966eeEBeFe59C3a3";
        handleBridge(gateway, feeToken);
    };
...
_s(Home, "+x8oF5VW1O7fSrQ7DoxaYtQD1zA=", false, function() {
    return [
...
//# sourceMappingURL=_d8a7540a._.js.map