...
export function BridgeButton({ onClick, disabled, isLoading }: BridgeButtonProps) {
  ...
  return (
    <button
      ...
      className="w-full py-4 rounded-2xl font-black text-lg transition-all duration-300 border-3 border-black  disabled:opacity-50 disabled:cursor-not-allowed active:translate-y-1"
    >
