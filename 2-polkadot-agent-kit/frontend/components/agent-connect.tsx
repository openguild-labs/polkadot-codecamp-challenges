      ...
      <div className="w-full max-w-2xl">
        ...
        <form onSubmit={handleConnect} className="space-y-6">
              ...
              {availableChains.map((chain: any) => (
                <button
                  ...
                  style={{
                    ...
                    transition: "all 0.2s",
                    border: "2px solid #1a1a1a",
                    background: selectedChains.includes(chain) ? "#ff6b9d" : "white",
                    color: selectedChains.includes(chain) ? "white" : "#1a1a1a",
                    boxShadow: selectedChains.includes(chain) ? "2px 2px 0px #1a1a1a" : "none",
                    cursor: "pointer",
                  }}
                >
                  {chain}
          ...
          <button
            ...
            style={{
              width: "100%",
              background: disabled || loading || selectedChains.length === 0 ? "#ccc" : "#ff6b9d",
              color: "white",
              fontWeight: "bold",
              padding: "12px",
              borderRadius: "8px 6px 4px 8px",
