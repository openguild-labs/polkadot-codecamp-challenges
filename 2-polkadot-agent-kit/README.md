...
- **Demo Video**: [
  Polkadot Codecamp Challenge 2 - XCM Cross-Chain Agent with Polkadot Agent Kit](https://youtu.be/D4lLObnxyrU)
...
const voteConfig: ToolConfig = {
  ...
  schema: z.object({
    ...
    chain: z
      .string()
      .describe(
        "The chain to vote on, e.g. polkadot, polkadot_asset_hub, west",
      ),
  }),
};
